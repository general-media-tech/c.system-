/* GMT PWA — عامل الخدمة | التطبيق: الأوردرات | الإصدار: v7 (إصلاحات الفحص العميق 2026-07-12)
...
const CACHE = 'gmt-orders--v20260713';
const PRECACHE = ["./orders-final.html", "./gmt-tour.js", "./gmt-welcome.js", "./gmt-sandbox.js", "./gmt-bugcatcher.js", "./gmt-inspector.js", "./gmt-scenarios.js", "./gmt-config.js", "./gmt-theme.css", "./logo.jpg", "./manifest.json", "./gmt-icon-192.png", "./gmt-icon-512.png", "./gmt-ui.js", "./gmt-guide.js", "./gmt-health-panel.js"];
...
self.addEventListener('activate', (e) => {
  e.waitUntil(
    caches.keys()
      .then((ks) => Promise.all(ks.filter((k) => k.startsWith('gmt-orders-') && k !== CACHE).map((k) => caches.delete(k))))
