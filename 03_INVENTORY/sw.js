/* GMT PWA — عامل الخدمة | التطبيق: الجرد | الإصدار: v5 (المفتّش)
...
const CACHE = 'gmt-inv--v20260713';
const PRECACHE = ["./index_inventory.html", "./gmt-cache.js", "./gmt-training.js", "./gmt-sandbox.js", "./gmt-bugcatcher.js", "./gmt-integrity.js", "./gmt-inspector.js", "./gmt-scenarios.js", "./gmt-config.js", "./gmt-theme.css", "./logo.jpg", "./manifest.json", "./gmt-icon-192.png", "./gmt-icon-512.png", "./gmt-ui.js", "./gmt-guide.js", "./gmt-health-panel.js"];
...
self.addEventListener('activate', (e) => {
  e.waitUntil(
    caches.keys()
      .then((ks) => Promise.all(ks.filter((k) => k.startsWith('gmt-inv-') && k !== CACHE).map((k) => caches.delete(k))))
